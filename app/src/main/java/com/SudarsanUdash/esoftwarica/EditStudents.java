...
public class EditStudents extends AppCompatActivity implements RadioGroup.OnCheckedChangeListener {
    ...
    public static int index;
                ...
                public void onClick(View v) {
                    if (validate()) {
                        ...
                        try {
                            ...
                            Toast.makeText(EditStudents.this, "Student updated", Toast.LENGTH_SHORT).show();
                            finish();
                        } catch (Exception e) {
                            e.printStackTrace();
                            Toast.makeText(EditStudents.this, e.getLocalizedMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                }
            });
        ...
        private boolean validate() {
            if (TextUtils.isEmpty(etReName.getText())) {
                ...
                Toast.makeText(EditStudents.this, "Select gender", Toast.LENGTH_SHORT).show();
                return false;
            }
            return true;
        }
